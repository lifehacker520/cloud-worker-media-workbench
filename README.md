...
- 账号矩阵支持按平台/状态筛选；删除账号前二次确认，并同步删除本地已抓取的该账号作品。
...
- 工作台已经预留总览、账号矩阵、监控中心、内容中心、发布中心、数据洞察、AI 工作区、反馈协作、设置与更新等模块入口；当前优先实现账号和作品监控。
...
抖音当前是 Beta 适配：公开主页可能返回安全校验页，Demo 会明确记录失败原因，不绕过验证码、登录限制或平台安全机制。若要稳定监控自有抖音账号，下一步应接入抖音官方授权的数据能力；视频号、AI 摘要、钉钉/飞书通知、人工确认队列和通知 Webhook 仍未实现。
