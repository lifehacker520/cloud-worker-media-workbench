...
- 内容编辑云员工已收敛为父级入口页，口播视频生产由下级的 AI 数字人口播生产中心承担（P01–P08）；26 节点工作流的前端长页已下线，其后端能力保留。内容任务、运行事件、媒体资产、知识文档、发布草稿写入 `data/workbench.sqlite`；旧 `content-tasks.json` 仅作为兼容镜像。
